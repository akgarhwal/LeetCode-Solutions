...
Submission Url: https://leetcode.com/problems/apply-discount-every-n-orders/submissions/305757784
*/
...
public class Cashier {
    ...
    public double GetBill(int[] product, int[] amount) {
        ...
        for(int index = 0; index < product.Length; index++){
            ...
            final_amount += ((double)prices[products[product[index]-1]-1] * (double)amount[index]);
