...
Submission Url: https://leetcode.com/problems/design-movie-rental-system/submissions/513788696
*/
...
public:
    ...
    void drop(int shop, int movie) {
        ...
        auto it = rented.find({shop, movie, price});
        rented.erase(it);
    }
