...
Submission Url: https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/submissions/889740042
*/
...
public:
    ...
    vector<int> twoSum(vector<int>& nums, int target) {
        ...
        for(int i = 0; i < nums.size(); i++) {
            ...
            if( index == i and index+1 < nums.size() and nums[i] == nums[index+1]) {
                ans.push_back(i+1);
