...
Submission Url: https://leetcode.com/problems/basic-calculator-ii/submissions/325304380
*/
    ...
    int calculate(string s) {
        ...
        while(ops_index < ops.size()){
            ...
            if(ops[ops_index] == '+' or ops[ops_index] == '-'){
                ...
                res += performOps(res, pval, ops[ops_index]);
                pval = numbers[ops_index + 1];
        ...
        if(ops[ops_index-1] == '*' or ops[ops_index-1] == '/'){
            res = res + pval;
        }
