...
Submission Url: https://leetcode.com/problems/closest-divisors/submissions/305939350
*/
...
public:
    ...
    void generateDivisors(int curIndex, long long curDivisor, vector<primeFactorization>& arr, vector<int>& ans, int num) 
    { 
