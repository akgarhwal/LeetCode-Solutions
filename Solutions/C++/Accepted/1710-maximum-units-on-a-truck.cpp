/*
Problem Title: 1710 - Maximum Units on a Truck
Lang: C++
Runtime: 216 ms
Memory: 49.4 MB
Problem Url: https://leetcode.com/problems/maximum-units-on-a-truck
Submission Url: https://leetcode.com/problems/maximum-units-on-a-truck/submissions/507689555
*/

class Solution {
public:
    
    int static sortBy(vector<int> a, vector<int> b){
