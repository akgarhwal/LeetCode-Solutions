...
Submission Url: https://leetcode.com/problems/remove-letter-to-equalize-frequency/submissions/869784024
*/
...
public:
    bool equalFrequency(string word) {
        ...
        if(chCount == 1 or (mx-1 == mi and sum-1 == mi*chCount) or (mx == mi and mx == 1) or (mi==1 and sum-1 == mx*(chCount-1))) {
            return true;
        }
        return false;
    }
